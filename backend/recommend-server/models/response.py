...
class ProblemResponse(BaseModel):
    ...
    def from_problem(cls, problem: Union[Problem, Dict]) -> "ProblemResponse":
        ...
        return cls(
            ...
            word_count=problem.metadata.get('word_count'),
            word_avg=problem.metadata.get('word_avg'),
            word_hard=problem.metadata.get('word_hard'),
            length=problem.metadata.get('length'),
            classification=problem.metadata.get('classification'),
            ...
            metadata=Metadata(options=problem.metadata['options']),
            vector=problem.metadata.get('vector'),
